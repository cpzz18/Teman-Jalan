...
const FIGMA_PROTOTYPE_URL =
  'https://embed.figma.com/proto/Gnz6Qf3CSmbYVizRJR2cCC/Desain-Prototype?node-id=13-6&scaling=scale-down&content-scaling=responsive&page-id=0%3A1&starting-point-node-id=13%3A6&embed-host=share'
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <div ref={textRef}>
              ...
              <p className="text-gray-500 text-lg md:text-xl leading-relaxed max-w-lg mx-auto md:mx-0">
                Teman Jalan adalah aplikasi transportasi digital yang memudahkan pengguna
                untuk memesan perjalanan dengan cepat, aman, dan nyaman dalam aktivitas sehari-hari.
              </p>
            </div>
