const socials = [
  ...
  {
    label: 'Email',
    href: 'mailto:hello@temanjalan.id',
    svg: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    <footer className="bg-gray-900 text-gray-300 py-16 relative overflow-hidden">
      <div
        ...
        style={{ background: 'linear-gradient(90deg, transparent, #00C853, transparent)' }}
      />
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-2 mb-3">
              ...
              <span className="font-bold text-lg text-white tracking-tight">Teman Jalan</span>
            </div>
            <p className="text-sm text-gray-500 max-w-xs">
              Studi kasus UI/UX Design Thinking untuk aplikasi pencari teman perjalanan.
            </p>
          </div>

          <nav className="flex items-center gap-6 flex-wrap justify-center">
            {['#fitur', '#proses', '#prototype', '#test'].map((href) => (
              <a
                key={href}
                href={href}
        ...
        <div className="border-t border-gray-800 mt-10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-500 text-center md:text-left">
            &copy; {year} Teman Jalan &mdash; UI/UX Case Study Portfolio. All rights reserved.
          </p>
          <p className="text-sm text-gray-600 text-center">
            Dibuat dengan <span className="text-green-500">♥</span> menggunakan React + Vite + GSAP
          </p>
        </div>
      </div>
    </footer>
